...
function ns_venta_bodega_cnt_shortcode (  ) {
...
add_action( 'wp_ajax_venta_bodega_cnt_shortcode', 'ns_venta_bodega_cnt_shortcode' );
add_action( 'wp_ajax_nopriv_venta_bodega_cnt_shortcode', 'ns_venta_bodega_cnt_shortcode' );
